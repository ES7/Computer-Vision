...
ebad_image = face_recognition.load_image_file("C:\\Users\\sayed\\Desktop\\InterIIT\\Face Detection\\images\\Ebad.jpg")
ebad_face_encoding = face_recognition.face_encodings(ebad_image)[0]

director_image = face_recognition.load_image_file("C:\\Users\\sayed\\Desktop\\InterIIT\\Face Detection\\images\\Director.jpg")
...
known_face_encodings = [obama_face_encoding,elon_face_encoding,ebad_face_encoding,director_face_encoding,CR7_face_encoding,LM10_face_encoding,Virat_face_encoding,Dhoni_face_encoding]
known_face_names = ["Obama","Elon Musk","Ebad Sayed","Director","Ronaldo","Leo Messi","Virat Kohli","M.S.Dhoni"]
